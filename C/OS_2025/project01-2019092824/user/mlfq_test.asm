...
user/_mlfq_test:     file format elf64-littleriscv
...
main(int argc, char *argv[])
{
   ...
   6:	0880                	addi	s0,sp,80
    mlfqmode();
   8:	46e000ef          	jal	476 <mlfqmode>
    int pid = fork();
   c:	3b2000ef          	jal	3be <fork>
    if (pid == 0) {
  10:	e179                	bnez	a0,d6 <main+0xd6>
  12:	fc26                	sd	s1,56(sp)
  14:	f84a                	sd	s2,48(sp)
  16:	892a                	mv	s2,a0
        int ppid = fork();
  18:	3a6000ef          	jal	3be <fork>
  1c:	84aa                	mv	s1,a0
        if(ppid == 0){
  ...
  26:	99e50513          	addi	a0,a0,-1634 # 9c0 <malloc+0x106>
  2a:	7dc000ef          	jal	806 <printf>
            while (1) {
                p5++;
                if(p5 % 1000 == 0){
  2e:	3e800913          	li	s2,1000
                    printf("5 lev is %d\n", getlev());
  32:	00001997          	auipc	s3,0x1
  36:	99698993          	addi	s3,s3,-1642 # 9c8 <malloc+0x10e>
                p5++;
  3a:	0014879b          	addiw	a5,s1,1
  3e:	0007849b          	sext.w	s1,a5
                if(p5 % 1000 == 0){
  42:	0327e7bb          	remw	a5,a5,s2
  46:	fbf5                	bnez	a5,3a <main+0x3a>
                    printf("5 lev is %d\n", getlev());
  48:	436000ef          	jal	47e <getlev>
  4c:	85aa                	mv	a1,a0
  4e:	854e                	mv	a0,s3
  50:	7b6000ef          	jal	806 <printf>
  54:	b7dd                	j	3a <main+0x3a>
  56:	f44e                	sd	s3,40(sp)
  58:	f052                	sd	s4,32(sp)
  5a:	ec56                	sd	s5,24(sp)
  5c:	e85a                	sd	s6,16(sp)
  ...
  64:	97850513          	addi	a0,a0,-1672 # 9d8 <malloc+0x11e>
  68:	79e000ef          	jal	806 <printf>
            while (1) {
  ...
  78:	99ca8a93          	addi	s5,s5,-1636 # a10 <malloc+0x156>
                        printf("not found a process\n");
  7c:	00001b97          	auipc	s7,0x1
  80:	97cb8b93          	addi	s7,s7,-1668 # 9f8 <malloc+0x13e>
                        printf("p4 set priority : to 0\n");
  84:	00001b17          	auipc	s6,0x1
  88:	95cb0b13          	addi	s6,s6,-1700 # 9e0 <malloc+0x126>
  8c:	a021                	j	94 <main+0x94>
  8e:	855a                	mv	a0,s6
  90:	776000ef          	jal	806 <printf>
                p4++;   
  94:	0019079b          	addiw	a5,s2,1
  98:	0007891b          	sext.w	s2,a5
                if(p4 % 1000 == 0){
  9c:	0297e7bb          	remw	a5,a5,s1
  a0:	fbf5                	bnez	a5,94 <main+0x94>
                    int setpriority_result = setpriority(4, 0);
  a2:	4581                	li	a1,0
  a4:	4511                	li	a0,4
  a6:	3e0000ef          	jal	486 <setpriority>
                    if(setpriority_result == 0){
  aa:	d175                	beqz	a0,8e <main+0x8e>
                    }else if(setpriority_result == -1){
  ac:	01350863          	beq	a0,s3,bc <main+0xbc>
                    }else if (setpriority_result == -2){
  b0:	01451a63          	bne	a0,s4,c4 <main+0xc4>
                        printf("Invalid setpriority\n");
  b4:	8556                	mv	a0,s5
  b6:	750000ef          	jal	806 <printf>
  ba:	bfe9                	j	94 <main+0x94>
                        printf("not found a process\n");
  bc:	855e                	mv	a0,s7
  be:	748000ef          	jal	806 <printf>
  c2:	bfc9                	j	94 <main+0x94>
                    }else{
                        printf("Error in setpriority\n");
  c4:	00001517          	auipc	a0,0x1
  c8:	96450513          	addi	a0,a0,-1692 # a28 <malloc+0x16e>
  cc:	73a000ef          	jal	806 <printf>
                        exit(1);
  d0:	4505                	li	a0,1
  d2:	2f4000ef          	jal	3c6 <exit>
  d6:	fc26                	sd	s1,56(sp)
  d8:	f84a                	sd	s2,48(sp)
  da:	f44e                	sd	s3,40(sp)
  dc:	f052                	sd	s4,32(sp)
  ...
  e8:	95c50513          	addi	a0,a0,-1700 # a40 <malloc+0x186>
  ec:	71a000ef          	jal	806 <printf>
        int p3 = 0;
  f0:	4481                	li	s1,0
        while (1) {
            p3++;
  ...
  f8:	5a79                	li	s4,-2
                    printf("Invalid setpriority\n");
  fa:	00001a97          	auipc	s5,0x1
  fe:	916a8a93          	addi	s5,s5,-1770 # a10 <malloc+0x156>
                    printf("not found a process\n");
 102:	00001b97          	auipc	s7,0x1
 106:	8f6b8b93          	addi	s7,s7,-1802 # 9f8 <malloc+0x13e>
                    printf("p3 set priority : to 2\n");
 10a:	00001b17          	auipc	s6,0x1
 10e:	93eb0b13          	addi	s6,s6,-1730 # a48 <malloc+0x18e>
 112:	a021                	j	11a <main+0x11a>
 114:	855a                	mv	a0,s6
 116:	6f0000ef          	jal	806 <printf>
            p3++;
 11a:	0014879b          	addiw	a5,s1,1
 11e:	0007849b          	sext.w	s1,a5
            if(p3 % 1000 == 0){
 122:	0327e7bb          	remw	a5,a5,s2
 126:	fbf5                	bnez	a5,11a <main+0x11a>
                int setpriority_result = setpriority(3, 2);
 128:	4589                	li	a1,2
 12a:	450d                	li	a0,3
 12c:	35a000ef          	jal	486 <setpriority>
                if(setpriority_result == 0){
 130:	d175                	beqz	a0,114 <main+0x114>
                }else if(setpriority_result == -1){
 132:	01350863          	beq	a0,s3,142 <main+0x142>
                }else if (setpriority_result == -2){
 136:	01451a63          	bne	a0,s4,14a <main+0x14a>
                    printf("Invalid setpriority\n");
 13a:	8556                	mv	a0,s5
 13c:	6ca000ef          	jal	806 <printf>
 140:	bfe9                	j	11a <main+0x11a>
                    printf("not found a process\n");
 142:	855e                	mv	a0,s7
 144:	6c2000ef          	jal	806 <printf>
 148:	bfc9                	j	11a <main+0x11a>
                }else{
                    printf("Error in setpriority\n");
 14a:	00001517          	auipc	a0,0x1
 14e:	8de50513          	addi	a0,a0,-1826 # a28 <malloc+0x16e>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4ce:	59e50513          	addi	a0,a0,1438 # a68 <digits>
 4d2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 764:	308b8b93          	addi	s7,s7,776 # a68 <digits>
 ...
 7b2:	2b290913          	addi	s2,s2,690 # a60 <malloc+0x1a6>
        for(; *s; s++)
