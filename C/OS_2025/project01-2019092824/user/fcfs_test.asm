...
user/_fcfs_test:     file format elf64-littleriscv
...
main(int argc, char *argv[])
{
   ...
   6:	0800                	addi	s0,sp,16
    fcfsmode();
   8:	382000ef          	jal	38a <fcfsmode>
    int pid = fork();
   c:	2ce000ef          	jal	2da <fork>
    if (pid == 0) {
  10:	67e1                	lui	a5,0x18
  12:	6a078793          	addi	a5,a5,1696 # 186a0 <base+0x17690>
  16:	cd19                	beqz	a0,34 <main+0x34>
            wait(0);
            exit(0);
        }
    } else {
  ...
  1a:	fffd                	bnez	a5,18 <main+0x18>
            //printf("4\n");
            p4++;
        }
        printf("4 done\n");
  1c:	00001517          	auipc	a0,0x1
  20:	8c450513          	addi	a0,a0,-1852 # 8e0 <malloc+0x10a>
  24:	6fe000ef          	jal	722 <printf>
    }
    wait(0);
  28:	4501                	li	a0,0
  2a:	2c0000ef          	jal	2ea <wait>
    exit(0);
  2e:	4501                	li	a0,0
  30:	2b2000ef          	jal	2e2 <exit>
        int ppid = fork();
  34:	2a6000ef          	jal	2da <fork>
        if(ppid == 0){
  38:	ed19                	bnez	a0,56 <main+0x56>
  3a:	67e1                	lui	a5,0x18
  3c:	6a078793          	addi	a5,a5,1696 # 186a0 <base+0x17690>
            while (p6 < 100000) {
  40:	37fd                	addiw	a5,a5,-1
  42:	fffd                	bnez	a5,40 <main+0x40>
            printf("6 done\n");
  44:	00001517          	auipc	a0,0x1
  48:	88c50513          	addi	a0,a0,-1908 # 8d0 <malloc+0xfa>
  4c:	6d6000ef          	jal	722 <printf>
            exit(0);
  50:	4501                	li	a0,0
  52:	290000ef          	jal	2e2 <exit>
  56:	67e1                	lui	a5,0x18
  58:	6a078793          	addi	a5,a5,1696 # 186a0 <base+0x17690>
            while (p5 < 100000) {
  5c:	37fd                	addiw	a5,a5,-1
  5e:	fffd                	bnez	a5,5c <main+0x5c>
            printf("5 done\n");
  60:	00001517          	auipc	a0,0x1
  64:	87850513          	addi	a0,a0,-1928 # 8d8 <malloc+0x102>
  68:	6ba000ef          	jal	722 <printf>
            wait(0);
  6c:	4501                	li	a0,0
  6e:	27c000ef          	jal	2ea <wait>
            exit(0);
  72:	4501                	li	a0,0
  74:	26e000ef          	jal	2e2 <exit>
...
stat(const char *n, struct stat *st)
{
 ...
 1ca:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 1cc:	85ca                	mv	a1,s2
 1ce:	16c000ef          	jal	33a <fstat>
 1d2:	892a                	mv	s2,a0
  close(fd);
 1d4:	8526                	mv	a0,s1
 1d6:	134000ef          	jal	30a <close>
  return r;
 1da:	64a2                	ld	s1,8(sp)
}
 1dc:	854a                	mv	a0,s2
