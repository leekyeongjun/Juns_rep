...
user/_p1_test:     file format elf64-littleriscv
...
main(int argc, char *argv[])
{
   ...
   a:	1000                	addi	s0,sp,32
    int pid = fork();
   c:	2a4000ef          	jal	2b0 <fork>
    if (pid == 0) {
  10:	e10d                	bnez	a0,32 <main+0x32>
  12:	1f500493          	li	s1,501
        for (int i =0; i <= 500; i++) {
            printf("child!\n");
  16:	00001917          	auipc	s2,0x1
  1a:	89a90913          	addi	s2,s2,-1894 # 8b0 <malloc+0x104>
  1e:	854a                	mv	a0,s2
  20:	6d8000ef          	jal	6f8 <printf>
            yield();
  24:	334000ef          	jal	358 <yield>
        for (int i =0; i <= 500; i++) {
  28:	34fd                	addiw	s1,s1,-1
  2a:	f8f5                	bnez	s1,1e <main+0x1e>
        for (int i =0; i <= 500; i++) {
            printf("parent!\n");
            yield();
        }
    ...
    exit(0);
  2c:	4501                	li	a0,0
  2e:	28a000ef          	jal	2b8 <exit>
  32:	1f500493          	li	s1,501
            printf("parent!\n");
  36:	00001917          	auipc	s2,0x1
  3a:	88290913          	addi	s2,s2,-1918 # 8b8 <malloc+0x10c>
  3e:	854a                	mv	a0,s2
  40:	6b8000ef          	jal	6f8 <printf>
            yield();
  44:	314000ef          	jal	358 <yield>
        for (int i =0; i <= 500; i++) {
  48:	34fd                	addiw	s1,s1,-1
  4a:	f8f5                	bnez	s1,3e <main+0x3e>
  4c:	b7c5                	j	2c <main+0x2c>
