...
user/_p2_test:     file format elf64-littleriscv
...
main(int argc, char *argv[])
{
  ...
  12:	8b248493          	addi	s1,s1,-1870 # 8c0 <malloc+0x114>
    if (pid == 0) {
  16:	c519                	beqz	a0,24 <main+0x24>
        for (;;) {printf("4\n"); yield();}
  18:	8526                	mv	a0,s1
  1a:	6de000ef          	jal	6f8 <printf>
  1e:	33a000ef          	jal	358 <yield>
  22:	bfdd                	j	18 <main+0x18>
        int ppid = fork();
  24:	28c000ef          	jal	2b0 <fork>
            for (;;) {printf("5\n"); yield();}
  28:	00001497          	auipc	s1,0x1
  2c:	89048493          	addi	s1,s1,-1904 # 8b8 <malloc+0x10c>
        if (ppid == 0) {
  30:	e909                	bnez	a0,42 <main+0x42>
            for (;;) {printf("6\n");}
  32:	00001497          	auipc	s1,0x1
  36:	87e48493          	addi	s1,s1,-1922 # 8b0 <malloc+0x104>
  3a:	8526                	mv	a0,s1
  3c:	6bc000ef          	jal	6f8 <printf>
  40:	bfed                	j	3a <main+0x3a>
            for (;;) {printf("5\n"); yield();}
  42:	8526                	mv	a0,s1
  44:	6b4000ef          	jal	6f8 <printf>
  48:	310000ef          	jal	358 <yield>
  4c:	bfdd                	j	42 <main+0x42>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3c0:	51450513          	addi	a0,a0,1300 # 8d0 <digits>
 3c4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 656:	27eb8b93          	addi	s7,s7,638 # 8d0 <digits>
 ...
 6a4:	22890913          	addi	s2,s2,552 # 8c8 <malloc+0x11c>
        for(; *s; s++)
