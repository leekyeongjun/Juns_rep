...
volatile static int started = 0; // syncronization
...
{ 
  ...
  if(cpuid() == 0){ 
    ...
    __sync_synchronize(); // compiler magic to prevent reordering
    started = 1;
  } else {
    while(started == 0)
...
0000000080001d14 <scheduler>:
{
  ...
  c->proc = 0;
    ...
    80001d38:	66c70713          	addi	a4,a4,1644 # 800123a0 <pid_lock>
    80001d3c:	975a                	add	a4,a4,s6
    80001d3e:	02073823          	sd	zero,48(a4)
        swtch(&c->context, &p->context);
    80001d42:	00010717          	auipc	a4,0x10
    80001d46:	69670713          	addi	a4,a4,1686 # 800123d8 <cpus+0x8>
    ...
    80001d54:	650a0a13          	addi	s4,s4,1616 # 800123a0 <pid_lock>
    80001d58:	9a3e                	add	s4,s4,a5
        found = 1;
    80001d5a:	4b85                	li	s7,1
    for(p = proc; p < &proc[NPROC]; p++) {
    80001d5c:	00016997          	auipc	s3,0x16
    80001d60:	47498993          	addi	s3,s3,1140 # 800181d0 <tickslock>
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001dc0:	a1448493          	addi	s1,s1,-1516 # 800127d0 <proc>
      if(p->state == RUNNABLE) {
...
0000000080001dc8 <sched>:
{
  ...
  if(mycpu()->noff != 1)
    ...
    80001dec:	5b870713          	addi	a4,a4,1464 # 800123a0 <pid_lock>
  ...
  intena = mycpu()->intena;
    ...
    80001e12:	59290913          	addi	s2,s2,1426 # 800123a0 <pid_lock>
  ...
  swtch(&p->context, &mycpu()->context);
    ...
    80001e2a:	5b258593          	addi	a1,a1,1458 # 800123d8 <cpus+0x8>
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001f12:	8c248493          	addi	s1,s1,-1854 # 800127d0 <proc>
    if(p != myproc()){
      acquire(&p->lock);
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001f1e:	2b690913          	addi	s2,s2,694 # 800181d0 <tickslock>
...
0000000080001f64 <reparent>:
{
  ...
  for(pp = proc; pp < &proc[NPROC]; pp++){
    ...
    80001f7a:	85a48493          	addi	s1,s1,-1958 # 800127d0 <proc>
      pp->parent = initproc;
    80001f7e:	00008a17          	auipc	s4,0x8
    80001f82:	2eaa0a13          	addi	s4,s4,746 # 8000a268 <initproc>
  for(pp = proc; pp < &proc[NPROC]; pp++){
    80001f86:	00016997          	auipc	s3,0x16
    80001f8a:	24a98993          	addi	s3,s3,586 # 800181d0 <tickslock>
...
0000000080001fba <exit>:
{
  ...
  if(p == initproc)
    ...
    80001fd6:	2967b783          	ld	a5,662(a5) # 8000a268 <initproc>
  ...
  acquire(&wait_lock);
    ...
    8000201e:	39e48493          	addi	s1,s1,926 # 800123b8 <wait_lock>
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80002070:	76448493          	addi	s1,s1,1892 # 800127d0 <proc>
    80002074:	00016997          	auipc	s3,0x16
    80002078:	15c98993          	addi	s3,s3,348 # 800181d0 <tickslock>
    acquire(&p->lock);
...
0000000080002110 <wait>:
{
  ...
  acquire(&wait_lock);
    ...
    80002134:	28850513          	addi	a0,a0,648 # 800123b8 <wait_lock>
    ...
    80002146:	08e98993          	addi	s3,s3,142 # 800181d0 <tickslock>
    sleep(p, &wait_lock);  //DOC: wait-sleep
    8000214a:	00010c17          	auipc	s8,0x10
    8000214e:	26ec0c13          	addi	s8,s8,622 # 800123b8 <wait_lock>
    ...
    80002180:	23c50513          	addi	a0,a0,572 # 800123b8 <wait_lock>
    ...
    800021ac:	21050513          	addi	a0,a0,528 # 800123b8 <wait_lock>
    ...
    800021f4:	5e048493          	addi	s1,s1,1504 # 800127d0 <proc>
...
procdump(void)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800022c4:	66848493          	addi	s1,s1,1640 # 80012928 <proc+0x158>
    800022c8:	00016917          	auipc	s2,0x16
    800022cc:	06090913          	addi	s2,s2,96 # 80018328 <bcache+0x140>
    if(p->state == UNUSED)
      continue;
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    800023c0:	e1450513          	addi	a0,a0,-492 # 800181d0 <tickslock>
...
clockintr()
{
  ...
  asm volatile("csrw 0x14d, %0" : : "r" (x));
    ...
    800024a8:	d2c48493          	addi	s1,s1,-724 # 800181d0 <tickslock>
    800024ac:	8526                	mv	a0,s1
    800024ae:	f46fe0ef          	jal	80000bf4 <acquire>
    ticks++;
    800024b2:	00008517          	auipc	a0,0x8
    800024b6:	dbe50513          	addi	a0,a0,-578 # 8000a270 <ticks>
...
syscall(void)
{
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    // Here is when system call function is called.
    // For example, if the system call number is SYS_fork, sys_fork() is called.
  } else {
...
sys_sleep(void)
{
  ...
  acquire(&tickslock);
    ...
    80002926:	8ae50513          	addi	a0,a0,-1874 # 800181d0 <tickslock>
    8000292a:	acafe0ef          	jal	80000bf4 <acquire>
  ticks0 = ticks;
    8000292e:	00008917          	auipc	s2,0x8
    80002932:	94292903          	lw	s2,-1726(s2) # 8000a270 <ticks>
  while(ticks - ticks0 < n){
    ...
    80002944:	89098993          	addi	s3,s3,-1904 # 800181d0 <tickslock>
    80002948:	00008497          	auipc	s1,0x8
    8000294c:	92848493          	addi	s1,s1,-1752 # 8000a270 <ticks>
    if(killed(myproc())){
  ...
  release(&tickslock);
    ...
    80002978:	85c50513          	addi	a0,a0,-1956 # 800181d0 <tickslock>
  ...
  return 0;
    ...
    80002996:	83e50513          	addi	a0,a0,-1986 # 800181d0 <tickslock>
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    800029d6:	7fe50513          	addi	a0,a0,2046 # 800181d0 <tickslock>
    800029da:	a1afe0ef          	jal	80000bf4 <acquire>
  xticks = ticks;
    800029de:	00008497          	auipc	s1,0x8
    800029e2:	8924a483          	lw	s1,-1902(s1) # 8000a270 <ticks>
  release(&tickslock);
    800029e6:	00015517          	auipc	a0,0x15
    800029ea:	7ea50513          	addi	a0,a0,2026 # 800181d0 <tickslock>
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    80002a1e:	7ce50513          	addi	a0,a0,1998 # 800181e8 <bcache>
    80002a22:	952fe0ef          	jal	80000b74 <initlock>

  // Create linked list of buffers
  bcache.head.prev = &bcache.head;
    80002a26:	0001d797          	auipc	a5,0x1d
    80002a2a:	7c278793          	addi	a5,a5,1986 # 800201e8 <bcache+0x8000>
    80002a2e:	0001e717          	auipc	a4,0x1e
    80002a32:	a2270713          	addi	a4,a4,-1502 # 80020450 <bcache+0x8268>
    80002a36:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    80002a3a:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    80002a3e:	00015497          	auipc	s1,0x15
    80002a42:	7c248493          	addi	s1,s1,1986 # 80018200 <bcache+0x18>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    80002a9e:	74e50513          	addi	a0,a0,1870 # 800181e8 <bcache>
    80002aa2:	952fe0ef          	jal	80000bf4 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    80002aa6:	0001e497          	auipc	s1,0x1e
    80002aaa:	9fa4b483          	ld	s1,-1542(s1) # 800204a0 <bcache+0x82b8>
    80002aae:	0001e797          	auipc	a5,0x1e
    80002ab2:	9a278793          	addi	a5,a5,-1630 # 80020450 <bcache+0x8268>
    ...
    80002ada:	71250513          	addi	a0,a0,1810 # 800181e8 <bcache>
  ...
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    ...
    80002af0:	9ac4b483          	ld	s1,-1620(s1) # 80020498 <bcache+0x82b0>
    80002af4:	0001e797          	auipc	a5,0x1e
    80002af8:	95c78793          	addi	a5,a5,-1700 # 80020450 <bcache+0x8268>
  ...
  panic("bget: no buffers");
    ...
    80002b2c:	6c050513          	addi	a0,a0,1728 # 800181e8 <bcache>
...
brelse(struct buf *b)
{
  ...
  if (b->refcnt == 0) {
    ...
    80002bd6:	61678793          	addi	a5,a5,1558 # 800201e8 <bcache+0x8000>
    80002bda:	2b87b703          	ld	a4,696(a5)
    80002bde:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    80002be0:	0001e717          	auipc	a4,0x1e
    80002be4:	87070713          	addi	a4,a4,-1936 # 80020450 <bcache+0x8268>
  ...
  release(&bcache.lock);
    ...
    80002bf8:	5f450513          	addi	a0,a0,1524 # 800181e8 <bcache>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    80002c28:	5c450513          	addi	a0,a0,1476 # 800181e8 <bcache>
  ...
  release(&bcache.lock);
    ...
    80002c3a:	5b250513          	addi	a0,a0,1458 # 800181e8 <bcache>
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    80002c5c:	59050513          	addi	a0,a0,1424 # 800181e8 <bcache>
  ...
  release(&bcache.lock);
    ...
    80002c6e:	57e50513          	addi	a0,a0,1406 # 800181e8 <bcache>
...
bfree(int dev, uint b)
{
  ...
  bp = bread(dev, BBLOCK(b, sb));
    ...
    80002c96:	c327a783          	lw	a5,-974(a5) # 800208c4 <sb+0x1c>
...
0000000080002cec <balloc>:
{
  ...
  for(b = 0; b < sb.size; b += BPB){
    ...
    80002cfa:	bb67a783          	lw	a5,-1098(a5) # 800208ac <sb+0x4>
    ...
    80002d1a:	b92b0b13          	addi	s6,s6,-1134 # 800208a8 <sb>
...
0000000080002ee0 <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    80002ef8:	9d450513          	addi	a0,a0,-1580 # 800208c8 <itable>
    80002efc:	cf9fd0ef          	jal	80000bf4 <acquire>
  empty = 0;
    80002f00:	4901                	li	s2,0
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    80002f02:	0001e497          	auipc	s1,0x1e
    80002f06:	9de48493          	addi	s1,s1,-1570 # 800208e0 <itable+0x18>
    80002f0a:	0001f697          	auipc	a3,0x1f
    80002f0e:	46668693          	addi	a3,a3,1126 # 80022370 <log>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80002f3a:	99250513          	addi	a0,a0,-1646 # 800208c8 <itable>
  ...
  release(&itable.lock);
    ...
    80002f66:	96650513          	addi	a0,a0,-1690 # 800208c8 <itable>
...
fsinit(int dev) {
  ...
  memmove(sb, bp->data, sizeof(*sb));
    ...
    80002fa8:	90498993          	addi	s3,s3,-1788 # 800208a8 <sb>
  ...
  initlog(dev, &sb);
    ...
    80002fd4:	8d858593          	addi	a1,a1,-1832 # 800208a8 <sb>
...
0000000080002ff8 <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    80003012:	8ba50513          	addi	a0,a0,-1862 # 800208c8 <itable>
    80003016:	b5ffd0ef          	jal	80000b74 <initlock>
  for(i = 0; i < NINODE; i++) {
    8000301a:	0001e497          	auipc	s1,0x1e
    8000301e:	8d648493          	addi	s1,s1,-1834 # 800208f0 <itable+0x28>
    80003022:	0001f997          	auipc	s3,0x1f
    80003026:	35e98993          	addi	s3,s3,862 # 80022380 <log+0x10>
...
0000000080003050 <ialloc>:
{
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    80003058:	0001e717          	auipc	a4,0x1e
    8000305c:	85c72703          	lw	a4,-1956(a4) # 800208b4 <sb+0xc>
    ...
    80003078:	0001ea17          	auipc	s4,0x1e
    8000307c:	830a0a13          	addi	s4,s4,-2000 # 800208a8 <sb>
...
000000008000310c <iupdate>:
{
  ...
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80003124:	7a05a583          	lw	a1,1952(a1) # 800208c0 <sb+0x18>
...
000000008000318a <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    8000319a:	73250513          	addi	a0,a0,1842 # 800208c8 <itable>
  ...
  release(&itable.lock);
    ...
    800031ac:	72050513          	addi	a0,a0,1824 # 800208c8 <itable>
...
00000000800031c0 <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80003202:	6c25a583          	lw	a1,1730(a1) # 800208c0 <sb+0x18>
...
0000000080003342 <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    80003352:	57a50513          	addi	a0,a0,1402 # 800208c8 <itable>
  ...
  release(&itable.lock);
    ...
    8000336c:	56050513          	addi	a0,a0,1376 # 800208c8 <itable>
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80003398:	53450513          	addi	a0,a0,1332 # 800208c8 <itable>
    ...
    800033be:	50e50513          	addi	a0,a0,1294 # 800208c8 <itable>
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    ...
    800038dc:	a9890913          	addi	s2,s2,-1384 # 80022370 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800038fc:	aa870713          	addi	a4,a4,-1368 # 800223a0 <log+0x30>
...
000000008000392a <install_trans>:
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    8000392e:	a727a783          	lw	a5,-1422(a5) # 8002239c <log+0x2c>
    80003932:	08f05f63          	blez	a5,800039d0 <install_trans+0xa6>
{
    ...
    80003950:	a54a8a93          	addi	s5,s5,-1452 # 800223a0 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    80003954:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    80003956:	0001f997          	auipc	s3,0x1f
    8000395a:	a1a98993          	addi	s3,s3,-1510 # 80022370 <log>
...
00000000800039d2 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    800039e8:	98c48493          	addi	s1,s1,-1652 # 80022370 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003a1e:	98670713          	addi	a4,a4,-1658 # 800223a0 <log+0x30>
...
recover_from_log(void)
{
  ...
  log.lh.n = 0;
    ...
    80003a40:	9607a023          	sw	zero,-1696(a5) # 8002239c <log+0x2c>
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80003a66:	90e50513          	addi	a0,a0,-1778 # 80022370 <log>
    80003a6a:	98afd0ef          	jal	80000bf4 <acquire>
  while(1){
    if(log.committing){
    80003a6e:	0001f497          	auipc	s1,0x1f
    80003a72:	90248493          	addi	s1,s1,-1790 # 80022370 <log>
      sleep(&log, &log.lock);
    ...
    80003aaa:	8ca50513          	addi	a0,a0,-1846 # 80022370 <log>
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80003ad0:	8a448493          	addi	s1,s1,-1884 # 80022370 <log>
  ...
  if(log.outstanding == 0){
    ...
    80003af0:	88448493          	addi	s1,s1,-1916 # 80022370 <log>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    80003b08:	86c48493          	addi	s1,s1,-1940 # 80022370 <log>
    ...
    wakeup(&log);
    80003b36:	0001f497          	auipc	s1,0x1f
    80003b3a:	83a48493          	addi	s1,s1,-1990 # 80022370 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    80003b5c:	0001fa97          	auipc	s5,0x1f
    80003b60:	844a8a93          	addi	s5,s5,-1980 # 800223a0 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    80003b64:	0001fa17          	auipc	s4,0x1f
    80003b68:	80ca0a13          	addi	s4,s4,-2036 # 80022370 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80003bca:	7c07ab23          	sw	zero,2006(a5) # 8002239c <log+0x2c>
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    80003bec:	78890913          	addi	s2,s2,1928 # 80022370 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003c26:	77e70713          	addi	a4,a4,1918 # 800223a0 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
  ...
  log.lh.block[i] = b->blockno;
    ...
    80003c42:	73278793          	addi	a5,a5,1842 # 80022370 <log>
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    80003c56:	71e70713          	addi	a4,a4,1822 # 80022370 <log>
  ...
  log.lh.block[i] = b->blockno;
    ...
    80003c84:	6f070713          	addi	a4,a4,1776 # 80022370 <log>
  ...
  release(&log.lock);
    ...
    80003c96:	6de50513          	addi	a0,a0,1758 # 80022370 <log>
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    80003dbc:	70050513          	addi	a0,a0,1792 # 800224b8 <ftable>
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    80003dda:	6e250513          	addi	a0,a0,1762 # 800224b8 <ftable>
    80003dde:	e17fc0ef          	jal	80000bf4 <acquire>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    80003de2:	0001e497          	auipc	s1,0x1e
    80003de6:	6ee48493          	addi	s1,s1,1774 # 800224d0 <ftable+0x18>
    80003dea:	0001f717          	auipc	a4,0x1f
    80003dee:	68670713          	addi	a4,a4,1670 # 80023470 <disk>
    if(f->ref == 0){
  ...
  release(&ftable.lock);
    ...
    80003e02:	6ba50513          	addi	a0,a0,1722 # 800224b8 <ftable>
  ...
  return 0;
    ...
    80003e16:	6a650513          	addi	a0,a0,1702 # 800224b8 <ftable>
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003e3a:	68250513          	addi	a0,a0,1666 # 800224b8 <ftable>
  ...
  release(&ftable.lock);
    ...
    80003e50:	66c50513          	addi	a0,a0,1644 # 800224b8 <ftable>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003e80:	63c50513          	addi	a0,a0,1596 # 800224b8 <ftable>
  ...
  release(&ftable.lock);
    ...
    80003ebe:	5fe50513          	addi	a0,a0,1534 # 800224b8 <ftable>
  ...
  if(ff.type == FD_PIPE){
    ...
    80003ef6:	5c650513          	addi	a0,a0,1478 # 800224b8 <ftable>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    80004018:	40470713          	addi	a4,a4,1028 # 80022418 <devsw>
    ...
    80004052:	10078b63          	beqz	a5,80004168 <filewrite+0x11a>
{
  ...
  if(f->type == FD_PIPE){
    ...
    800040ba:	36270713          	addi	a4,a4,866 # 80022418 <devsw>
...
exec(char *path, char **argv)
{
 ...
 bad:
  ...
  ustack[argc] = 0;
    ...
    800046ca:	f9078793          	addi	a5,a5,-112 # ffffffffffffef90 <end+0xffffffff7ffdb9e0>
...
free_desc(int i)
{
  ...
  if(disk.free[i])
    ...
    800052e4:	19078793          	addi	a5,a5,400 # 80023470 <disk>
  ...
  disk.desc[i].addr = 0;
    ...
    800052f8:	17c78793          	addi	a5,a5,380 # 80023470 <disk>
  ...
  wakeup(&disk.free[0]);
    ...
    80005320:	16c50513          	addi	a0,a0,364 # 80023488 <disk+0x18>
...
0000000080005348 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    80005360:	23c50513          	addi	a0,a0,572 # 80023598 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_STATUS) = status;
  ...
  features &= ~(1 << VIRTIO_RING_F_INDIRECT_DESC);
    ...
    800053c8:	75f70713          	addi	a4,a4,1887 # ffffffffc7ffe75f <end+0xffffffff47fdb1af>
  ...
  *R(VIRTIO_MMIO_QUEUE_SEL) = 0;
  ...
  disk.desc = kalloc();
    ...
    8000541e:	05648493          	addi	s1,s1,86 # 80023470 <disk>
  ...
  if(!disk.desc || !disk.avail || !disk.used)
    ...
    8000543c:	04073703          	ld	a4,64(a4) # 80023478 <disk+0x8>
  ...
  memset(disk.avail, 0, PGSIZE);
    ...
    80005454:	02048493          	addi	s1,s1,32 # 80023470 <disk>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    80005570:	02c50513          	addi	a0,a0,44 # 80023598 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80005580:	ef4b0b13          	addi	s6,s6,-268 # 80023470 <disk>
  for(int i = 0; i < 3; i++){
  ...
  while(1){
    ...
    8000558a:	012c0c13          	addi	s8,s8,18 # 80023598 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    800055ac:	ec870713          	addi	a4,a4,-312 # 80023470 <disk>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    800055e4:	ea850513          	addi	a0,a0,-344 # 80023488 <disk+0x18>
  ...
  if(write)
    ...
    80005600:	e7478793          	addi	a5,a5,-396 # 80023470 <disk>
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    800056d6:	ec690913          	addi	s2,s2,-314 # 80023598 <disk+0x128>
  while(b->disk == 1) {
  ...
  disk.info[idx[0]].b = 0;
    ...
    800056fe:	d7678793          	addi	a5,a5,-650 # 80023470 <disk>
    80005702:	97ba                	add	a5,a5,a4
    80005704:	0007b423          	sd	zero,8(a5)
    int flag = disk.desc[i].flags;
    80005708:	0001e997          	auipc	s3,0x1e
    8000570c:	d6898993          	addi	s3,s3,-664 # 80023470 <disk>
  ...
  release(&disk.vdisk_lock);
    ...
    80005730:	e6c50513          	addi	a0,a0,-404 # 80023598 <disk+0x128>
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    80005760:	d1448493          	addi	s1,s1,-748 # 80023470 <disk>
    80005764:	0001e517          	auipc	a0,0x1e
    80005768:	e3450513          	addi	a0,a0,-460 # 80023598 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    800057dc:	dc050513          	addi	a0,a0,-576 # 80023598 <disk+0x128>
...
getppid(void)
{
    ...
    80005804:	8dcfc0ef          	jal	800018e0 <myproc>
    80005808:	84aa                	mv	s1,a0
    int ppid;
    
    acquire(&wait_lock);       // Acquire the wait_lock to safely access p->parent
    8000580a:	0000d517          	auipc	a0,0xd
    8000580e:	bae50513          	addi	a0,a0,-1106 # 800123b8 <wait_lock>
    80005812:	be2fb0ef          	jal	80000bf4 <acquire>
    if (p->parent) {
    80005816:	7c9c                	ld	a5,56(s1)
    80005818:	cf91                	beqz	a5,80005834 <getppid+0x3a>
        ppid = p->parent->pid;   // Retrieve the parent process's PID
    8000581a:	5b84                	lw	s1,48(a5)
    } else {
        ppid = -1;               // No parent (shouldn't happen for normal processes)
    }
    release(&wait_lock);       // Release the lock after accessing p->parent
    8000581c:	0000d517          	auipc	a0,0xd
    80005820:	b9c50513          	addi	a0,a0,-1124 # 800123b8 <wait_lock>
    80005824:	c68fb0ef          	jal	80000c8c <release>
    ...
    80005836:	b7dd                	j	8000581c <getppid+0x22>

0000000080005838 <sys_getppid>:
...
sys_getppid(void)
{
    ...
    return getppid();
    80005840:	fbbff0ef          	jal	800057fa <getppid>
