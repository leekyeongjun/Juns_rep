...
main(int argc, char *argv[])
{
   ...
   c:	89850513          	addi	a0,a0,-1896 # 8a0 <malloc+0x106>
  10:	6d6000ef          	jal	6e6 <printf>


    fprintf(1, "My pid is %d\n", getpid());
  14:	332000ef          	jal	346 <getpid>
  18:	862a                	mv	a2,a0
  1a:	00001597          	auipc	a1,0x1
  1e:	8a658593          	addi	a1,a1,-1882 # 8c0 <malloc+0x126>
  22:	4505                	li	a0,1
  24:	698000ef          	jal	6bc <fprintf>
    if(getppid() == -1){
  28:	33e000ef          	jal	366 <getppid>
  2c:	57fd                	li	a5,-1
  2e:	00f50f63          	beq	a0,a5,4c <main+0x4c>
        fprintf(1, "No parent process\n");
    } else {
        fprintf(1, "My ppid is %d\n", getppid());
  32:	334000ef          	jal	366 <getppid>
  36:	862a                	mv	a2,a0
  38:	00001597          	auipc	a1,0x1
  3c:	8b058593          	addi	a1,a1,-1872 # 8e8 <malloc+0x14e>
  40:	4505                	li	a0,1
  42:	67a000ef          	jal	6bc <fprintf>
    }
    exit(0);
  46:	4501                	li	a0,0
  48:	27e000ef          	jal	2c6 <exit>
        fprintf(1, "No parent process\n");
  4c:	00001597          	auipc	a1,0x1
  50:	88458593          	addi	a1,a1,-1916 # 8d0 <malloc+0x136>
  54:	4505                	li	a0,1
  56:	666000ef          	jal	6bc <fprintf>
  5a:	b7f5                	j	46 <main+0x46>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ae:	55650513          	addi	a0,a0,1366 # 900 <digits>
 3b2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 644:	2c0b8b93          	addi	s7,s7,704 # 900 <digits>
 ...
 692:	26a90913          	addi	s2,s2,618 # 8f8 <malloc+0x15e>
        for(; *s; s++)
